...
{
    /// <inheritdoc />
    public partial class AppVPP : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpendingLimit = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuperviorID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StationeryRequests_AspNetUsers_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StationeryRequests_AspNetUsers_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StationeryRequests_AspNetUsers_SuperviorID",
                        column: x => x.SuperviorID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StationeryRequests_StationeryItems_ItemID",
                        column: x => x.ItemID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Approvals", x => x.ApprovedId);
                    table.ForeignKey(
                        name: "FK_Approvals_AspNetUsers_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Approvals_StationeryItems_ItemID",
                        column: x => x.ItemID,
                        principalTable: "StationeryItems",
                        principalColumn: "ItemID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Approvals_StationeryRequests_RequestID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StationeryRequests_ApprovedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StationeryRequests_StationeryItemItemID",
                table: "StationeryRequests",
                column: "StationeryItemItemID");

            migrationBuilder.CreateIndex(
                name: "IX_StationeryRequests_SuperviorID",
                table: "StationeryRequests",
                column: "SuperviorID");
        }
